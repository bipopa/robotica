...
class JointAnglePositionPublisher(Node):
    def __init__(self):
        ...
        self.joint_1_final_angle = math.radians(900)
        self.joint_2_final_angle = math.radians(900)
        self.joint_3_final_angle = math.radians(900)
        self.joint_4_final_angle = math.radians(900)
