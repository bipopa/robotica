...
def generate_launch_description():
    ...
    pkg_share = FindPackageShare(package='centauri_visual').find('centauri_visual')
    default_launch_dir = os.path.join(pkg_share, 'launch')
    default_model_path = os.path.join(pkg_share, 'urdf/centauri6dof.urdf')
    robot_name_in_urdf = 'centauri6dof'
