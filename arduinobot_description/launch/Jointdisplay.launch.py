...
def generate_launch_description():
  ...
  pkg_share = FindPackageShare(package='arduinobot_description').find('arduinobot_description')
  default_launch_dir = os.path.join(pkg_share, 'launch')
  default_model_path = os.path.join(pkg_share, 'urdf/arduinobot.urdf.xacro')
  robot_name_in_urdf = 'arduinobot'
